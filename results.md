# Final Results: Comparison with Jegadeesh & Titman (1993)

This table compares the results from the local script (`My Code`) with the published results from Jegadeesh & Titman (1993), Table 1, Panel A.
